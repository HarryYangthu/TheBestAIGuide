...
<section><h2>方案结果</h2><div class="scroll"><table id="metrics"></table></div><p>未运行生成时答案指标为 N/A；异常任务仍计入分母，不能靠丢弃失败提高成绩。</p></section>
...
</script></html>'''.replace('EXTRA',extra).replace('BUNDLE',encoded)
