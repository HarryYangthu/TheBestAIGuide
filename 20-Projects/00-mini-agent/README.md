...
想系统理解每项能力的职责，配合阅读 [Agent 的 12 个核心组件与 3 个增强能力](../../10-Knowledge/03-agent-core/01-concepts/04-core-components.md)。正文沿用本项目的 Pine SDK 案例，逐项讲解机制、失败与验收；其中标注的调度、恢复、Skills 等扩展设计不等于本项目已实现。
