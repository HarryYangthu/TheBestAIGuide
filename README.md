...
| 你的目标 | 阅读入口 | 动手做什么 |
|---|---|---|
| 看清各组件怎样协作 | [Agent 组件总览](10-Knowledge/02_Harness/README.md) | 对照总览图找到任务、模型、循环、工具和验收的位置 |
| 从零写出执行循环 | [03：Agent 执行循环](10-Knowledge/02_Harness/03-agent-loop/README.md) | 真实 API 调用 → 读取笔记 → 修复函数 → 检查结果与运行报告 |
...
程序读取目录中实际存在的 `notes.txt`，打印笔记正文，并保存 `runs/input-preview.txt`。随后按[章节配置说明](10-Knowledge/02_Harness/03-agent-loop/README.md#api-配置)填写 URL、API Key 和模型名，依次运行 v0—v4。
...
| [10-Knowledge](10-Knowledge/README.md) | AI 知识库入口 |
| [10-Knowledge/02_Harness](10-Knowledge/02_Harness/README.md) | 12 个核心组件与 3 个增强能力的章节 |
