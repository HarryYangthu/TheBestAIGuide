...
Skill 中写“使用所有工具”也不会给脚本更多操作系统权限。调用它仍然是一次普通工具执行，必须服从 [08 的执行环境](../02_Harness/08-tools-and-environment/README.md)与 [12 的权限边界](../02_Harness/12-permissions-and-resources/README.md)。本章只在仓库内执行自己的可信包。
