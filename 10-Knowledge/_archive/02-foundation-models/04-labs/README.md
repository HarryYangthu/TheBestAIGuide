...
```bash
python scripts/check_notebooks.py --execute --backend ipython-fallback 10-Knowledge/_archive/02-foundation-models/04-labs/01-tokenization-and-attention.ipynb 10-Knowledge/_archive/02-foundation-models/04-labs/02-decoding-cache-and-precision.ipynb
```
