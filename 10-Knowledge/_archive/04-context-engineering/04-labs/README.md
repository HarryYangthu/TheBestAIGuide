...
```bash
python scripts/check_notebooks.py --execute 10-Knowledge/_archive/04-context-engineering/04-labs/01-token-budget.ipynb
python scripts/check_notebooks.py --execute 10-Knowledge/_archive/04-context-engineering/04-labs/02-context-compaction.ipynb
```
