...
当前阅读入口：[06｜上下文工程与管理](../../02%20Agent%20Harness/06-context-management/README.md)。原版知识点、实验与新版位置的对应关系见[内容覆盖表](../../02%20Agent%20Harness/06-context-management/coverage.md)。本目录保留历史正文与 Notebook 记录。
