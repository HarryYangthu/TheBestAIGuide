...
| 实现 | 运行方式（仓库根目录） | 已验证 |
|---|---|---|
| [Python 领域算例](application_cases.py) | `python 10-Knowledge/_archive/13-application-engineering/05-code/application_cases.py` | 权限过滤、能力选择、价格修复、运维建议、合成搜索 |
| [Python 测试](test_application_cases.py) | `python -m unittest discover -s 10-Knowledge/_archive/13-application-engineering/05-code -p 'test_*.py'` | 5 个测试通过，含正常与反例 |
