...
```bash
python scripts/check_notebooks.py --execute --backend ipython-fallback 10-Knowledge/_archive/15-multimodal-and-embodied/04-labs/01-document-evidence.ipynb
```
