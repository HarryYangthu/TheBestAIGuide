...
```bash
python scripts/check_notebooks.py --execute --backend ipython-fallback 10-Knowledge/_archive/01-ai-foundations/04-labs/01-math-and-optimization.ipynb 10-Knowledge/_archive/01-ai-foundations/04-labs/02-generalization-and-calibration.ipynb 10-Knowledge/_archive/01-ai-foundations/04-labs/deep-learning/01-autograd-and-training.ipynb 10-Knowledge/_archive/01-ai-foundations/04-labs/search-and-rl/01-search-and-value-learning.ipynb
```
