...
def client(output):
    ...
    messages = [
        ...
        {"jsonrpc": "2.0", "id": 3, "method": "tools/call", "params": {"name": "search_docs", "arguments": {"query": "初始库存", "limit": 5}}},
        {"jsonrpc": "2.0", "id": 4, "method": "tools/call", "params": {"name": "search_docs", "arguments": {"query": "初始库存", "limit": 200}}},
    ]
