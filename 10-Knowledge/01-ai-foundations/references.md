...
| F6 | [PyTorch Autograd mechanics](https://docs.pytorch.org/docs/2.14/notes/autograd.html)，2.14文档 | 计算图、反向微分与梯度行为 | 读取官方文档；本库运行的是自写标量引擎，未运行PyTorch |
...
| [强化学习](01-concepts/reinforcement-learning/README.md) | F9、F10 | [价值迭代与Q-learning](04-labs/search-and-rl/01-search-and-value-learning.ipynb) |
