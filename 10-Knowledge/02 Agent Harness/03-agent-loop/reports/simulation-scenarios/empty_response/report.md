...
- 模型：
- 状态：failed / empty_response_limit
- 模型请求尝试：2
...
| simulation_artifacts | False | {"passed": false, "error": "[Errno 2] No such file or directory: '/tmp/agent-loop-case-66c8i8g9/runs/simulation/metrics.json'"} |
