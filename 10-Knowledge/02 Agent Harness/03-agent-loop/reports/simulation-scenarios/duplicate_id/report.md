...
| simulation_artifacts | False | {"passed": false, "error": "[Errno 2] No such file or directory: '/tmp/agent-loop-case-277xodpq/runs/simulation/metrics.json'"} |
