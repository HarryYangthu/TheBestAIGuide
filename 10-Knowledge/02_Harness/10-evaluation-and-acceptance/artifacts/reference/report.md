...
| 版本 | 任务 | trial | 原因 |
|---|---|---:|---|
| baseline | invalid | 0 | invalid_value: sample=o2 |
| candidate | invalid | 0 | invalid_value: sample=o2 |
| baseline | invalid | 1 | invalid_value: sample=o2 |
| candidate | invalid | 1 | invalid_value: sample=o2 |
| baseline | invalid | 2 | invalid_value: sample=o2 |
| candidate | invalid | 2 | invalid_value: sample=o2 |
