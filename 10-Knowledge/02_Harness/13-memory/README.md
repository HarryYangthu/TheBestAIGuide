...
以下所有命令在 `10-Knowledge/02_Harness/13-memory/` 执行。需要 Python 3.10+，只使用标准库，无需 API Key 或第三方包。已验证 Python 3.12.14、SQLite 3.53.1。源码走读使用固定 CPython v3.12.8 快照，运行时版本与走读版本分别记录。
