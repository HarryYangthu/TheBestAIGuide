...
[阅读路线](README.md) · [上一篇：技能方法](01-method-from-task.md) · [下一篇：渐进加载](03-progressive-loading.md)
...
技能包包含适用条件、输入约定、执行命令和错误说明。脚本路径与参数应能直接用于调用。
...
退出码 0 表示脚本生成了文件，内容是否合格由[产物验收](04-validation-and-versioning.md)检查。

[下一篇：渐进加载](03-progressive-loading.md)
