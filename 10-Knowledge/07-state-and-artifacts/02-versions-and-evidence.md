...
[阅读路线](README.md) · [上一篇](01-state-and-files.md) · [下一篇：并发更新](03-concurrent-updates.md)
...
要交付的是一份代码及其可核对的验证依据。图中箭头表示“右侧产物使用了左侧的哪个版本”，而不是“这两个步骤曾经先后执行过”。本篇的完整入口是 `code/demo.py versions`。
...
下一篇再解决另一类风险：两个写者各自拥有合法产物，却基于同一份旧状态提交。
