# 大模型 Agent 算法与开发全栈知识树

> 目标：沉淀一份可持续维护、可导入 Notion、也能拆分成公众号文章的大模型 Agent 知识体系。

面向个人系统学习与内部培训的新版结构：[AI Agent 个人学习与内部培训知识库总纲](./AI-Agent-个人学习与内部培训知识库总纲.md)
...
专题文档：[Context Engineering](./Context-Engineering.md)

资源索引：[Context Engineering Resources](./Context-Engineering-Resources.md)
