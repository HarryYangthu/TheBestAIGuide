...
| 源仓主题 | 本知识库入口 | 处理方式 |
| --- | --- | --- |
| Agent 原理与 ReAct | [Agent Core](../../../20-Knowledge/03-agent-core/README.md) | 保留技术概念，待独立成文 |
| Context Engineering | [Context Engineering](../../../20-Knowledge/04-context-engineering/README.md) | 已重构为短专题 |
| Tool、MCP、Sandbox | [Tools 与协议](../../../20-Knowledge/05-tools-skills-protocols/README.md) | 保留，待补协议与安全边界 |
| RAG 与知识系统 | [RAG](../../../20-Knowledge/06-rag-and-knowledge-systems/README.md) | 已提炼流程和混合检索 |
| Memory | [Memory 与状态](../../../20-Knowledge/07-memory-and-state/README.md) | 与 Context、State 分开整理 |
| Workflow 与 Multi-Agent | [Planning 与 Multi-Agent](../../../20-Knowledge/08-planning-workflow-multi-agent/README.md) | 保留系统设计，不默认多 Agent |
| Runtime 与 Harness | [Runtime 与 Harness](../../../20-Knowledge/09-runtime-harness-environment/README.md) | 补齐恢复、幂等和环境 |
| Evaluation 与 Trace | [Evaluation](../../../20-Knowledge/10-evaluation-observability/README.md) | 已按评测对象拆分 |
| Safety 与权限 | [Safety](../../../20-Knowledge/11-safety-security-governance/README.md) | 待补威胁模型和治理 |
...
从源仓吸收的是技术骨架、内容工程方法和可验证的构建观察；不复制大段原文，不继承求职导向，也不把项目蓝图包装成完成项目。后续新增内容应优先连接到 [知识体系总纲](../../../10-Maps/00-Master-Map.md)，再根据需要落到 Knowledge、Patterns、Cases、Labs 或 Code。
